...
# csv_to_html.py - script to turn CSV files into more readable tables presented in HTML files.
# Terminal Usage: py csv_to_html.py <csv_file>.csv <location>/<html-filename>.html
...
def write_html_file(html_string, html_file):
    ...
    with open(html_file, 'w') as web_file:
        web_file.write(html_string)
